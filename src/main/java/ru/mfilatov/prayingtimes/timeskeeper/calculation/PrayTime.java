...
package ru.mfilatov.prayingtimes.timeskeeper.calculation;
...
public class PrayTime {
  ...
  private int Moscow; // Spiritual Administration of Muslims of Russia
  // Juristic Methods
  ...
  public PrayTime() {
    ...
    this.setMoscow(7); // Spiritual Administration of Muslims of Russia
  ...
  private ArrayList<String> getDatePrayerTimes(
  ...
  public ArrayList<String> getPrayerTimes(
      Calendar date, double latitude, double longitude, double tZone) {
  ...
  private double[] adjustHighLatTimes(double[] times) {
    ...
    // Adjust Isha
    double IshaAngle =
        (methodParams.get(this.getCalcMethod())[3] == 0)
            ? methodParams.get(this.getCalcMethod())[4]
            : 18;
    ...
    // Adjust Maghrib
    double MaghribAngle =
        (methodParams.get(this.getCalcMethod())[1] == 0)
            ? methodParams.get(this.getCalcMethod())[2]
            : 4;
